...
First, with the initial topic **Compare PRC (China) logistics industry with other regions and countries**. I want to find more related details: (*ChatGPT/ New Bing prompt*)
> I want you to act as a supply chain analyst, and help me to expand the following topic of PRC logistics industry: comparison with other markets.

<img src="/images/2023-03/Snipaste_2023-03-31_23-38-31.png"  width="80%">

### (2) Details $\to$ Data
Now I want to find some data to support the first point in the picture above: **Market Size and Growth** (*New Bing prompt*)
> I want you to act as an supply chian analyst, help me to compare the PRC logistics industry's market size and growth with other countries and regions
...
[2] Then ask AI to draw a Pie chart using Excel Macro: (*New Bing Prompt*)
> Using these data, write an excel macro commands to generate a pie chart

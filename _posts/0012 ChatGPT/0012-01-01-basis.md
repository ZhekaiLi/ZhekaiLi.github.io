...
### (2) Details $\to$ Data
Now I want to find some data to support the first point in the picture above: **Market Size and Growth**
...
[2] Then ask AI to draw a Pie chart using Excel Macro:
